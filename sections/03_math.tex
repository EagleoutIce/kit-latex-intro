...
\soldisablenumhl\tcbset{ebl@listing@post/.style={sidebyside=false}}\begin{itemize}
   ...
   \eblLoadLtx[morekeywords={[5]{\\displaystyle}}]{SimpleFormulas}{graphics options={trim=3cm 24cm 4cm 3cm, clip},width={.8\linewidth}}{listing above comment,width=\linewidth}
\end{itemize}
\end{frame}
