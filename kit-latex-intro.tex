...
\begin{frame}{Source}
   ...
   \begin{center}
      \fancyqr[l color=kit-purple!60!black,r color=kit-purple!60!kit-blue!40!black,height=3.25cm,image={\!\usebox\TempBoxA\,},level=H]{https://github.com/EagleoutIce/kit-latex-intro}
   \end{center}
\end{frame}
\backupend
