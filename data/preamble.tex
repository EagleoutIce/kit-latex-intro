...
\usepackage[encoding,print,highlights,nodefaultfont]{lib/sopra-collection/sopra-listings/sopra-listings}
\solLoadLanguage{latex,bash}
\lstcolorlet{keywordA}{kit-blue}
\lstcolorlet{keywordB}{kit-green50}
\lstcolorlet{keywordC}{kit-blue60}
...
\resizebox*!{4cm}{\begin{tikzpicture}
   ...
   \pgfonlayer{very-background}
      \draw[gray] ([xshift=-6cm]T-foot-right) -- ++(49cm,0);
   \endpgfonlayer
